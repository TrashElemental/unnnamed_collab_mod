...
public class SpiderArmorModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(infested.MOD_ID, "spider_armor"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head",
                CubeListBuilder.create().texOffs(0, 0)
                        ...
                        .addBox(-4.0F, -7.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.0F)).texOffs(17, 3)
                        .addBox(-1.0F, -9.0F, 1.0F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
