package net.trashelemental.collab_mod.entity.client.renderers;

import com.mojang.blaze3d.vertex.PoseStack;
import net.minecraft.client.renderer.MultiBufferSource;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import net.minecraft.resources.ResourceLocation;
import net.trashelemental.collab_mod.entity.client.models.TestBossNoBarModel;
import net.trashelemental.collab_mod.entity.client.models.TestBossWithBarModel;
